...
const run_migration_1 = require("./migrations/run-migration");
const StockLocationModels = __importStar(require("./models"));
const stock_location_1 = __importDefault(require("./services/stock-location"));
const service = stock_location_1.default;
const loaders = [connection_1.default];
...
exports.moduleDefinition = {
    ...
    loaders,
    models,
    runMigrations: run_migration_1.runMigrations,
    revertMigration: run_migration_1.revertMigration,
};
